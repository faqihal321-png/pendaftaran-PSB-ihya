...
app.get('/admin/export-excel', async (req, res) => {
    ...
    data.forEach((s, i) => {
        sheet.addRow({
            no: i + 1,
            tanggal: s.tanggal || s.tahunDaftar,
            nama: s.nama,
            jenjang: s.jenjang,
            nisn: s.nisn,
            nik: s.nik,
    ...
    res.setHeader('Content-Disposition', 'attachment; filename=Data_Santri_PSB_Backup.xlsx');
                        ...
                        <div class="tab-pane fade show active" id="v-dash">
                            ...
                            <div class="card border-0 shadow-sm p-4 rounded-4 bg-white mt-4">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <a href="/admin/export-excel" class="btn btn-primary fw-bold shadow-sm">
                                        <i class="fas fa-file-excel me-2"></i>BACKUP DATA (EXCEL)
                                    </a>
                                    <a href="/admin/download-berkas-zip" class="btn btn-warning fw-bold shadow-sm text-white">
                                        <i class="fas fa-file-archive me-2"></i>DOWNLOAD SEMUA FOTO (ZIP)
                                    </a>
                                </div>
                            </div>
                        </div>
