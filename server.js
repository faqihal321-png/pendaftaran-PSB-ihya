                ...
                <div class="main-content">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="v-dash">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4"><div class="card border-0 p-3 rounded-4 shadow-sm bg-white text-dark"><h6>Tahun Aktif:</h6><h5 class="fw-bold mb-0">${tahunAktif}</h5></div></div>
                                <div class="col-md-4"><div class="card border-0 p-3 rounded-4 shadow-sm bg-white text-success"><h6>Tarif Pondok:</h6><h5 class="fw-bold mb-0">Rp ${config.biayaPondok}</h5></div></div>
